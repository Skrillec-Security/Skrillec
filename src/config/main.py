...
class Config:
    ...
    local_cmdlog_db_path_backup =   os.getcwd() + "\\src\\assets\\logs\\cmds.log" # cmds logs
    ...
    local_err_path_backup =         os.getcwd() + "\\src\\assets\\logs\\erros.log"
    local_blacklist_path_backup =   os.getcwd() + "\\src\\assets\\db\\blacklisted.skrillec"
